...
public:
    ...
    IBFCell(int ids, int hashs, int c){
        idSum = ids;
        hashSum = hashs;
        count = c;
    }
    ...
    void set(int ids, int hashs, int c){
        idSum = ids;
        hashSum = hashs;
        count = c;
    }
...
*/
    ...
    */
    ...
    /* Incorrect answer
      A: 218 245 200 232 221 285 263 120 280 194
      B: 150 260 216 131 109 230 116 243 146 158 264
    */
/*
